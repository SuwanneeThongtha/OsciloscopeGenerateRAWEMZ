% Generate RAWEMZ file from 64 Excel/CSV files
...
% 4. Saves processed data as Excel/CSV file (64 rows × total_records columns)
...
fprintf('Please select 64 Excel or CSV files...\n');
if isOctave
